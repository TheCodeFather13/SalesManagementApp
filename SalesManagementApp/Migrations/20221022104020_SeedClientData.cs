    ...
    public partial class SeedClientData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "james.tailor@company.com", "James", "Buyer", "Tailor", "079564377", 1 },
                    { 2, "jill.hutton@company.com", "Jill", "Buyer", "Hutton", "070583327", 2 },
                    { 3, "craig.rice@company.com", "Craig", "Buyer", "Rice", "069447821", 3 },
                    { 4, "amy.smith@company.com", "Amy", "Buyer", "Smith", "079753210", 4 }
                });
